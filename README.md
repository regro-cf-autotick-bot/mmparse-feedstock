...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mmparse-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13829&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mmparse-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mmparse` can be installed with:

```
conda install mmparse
```

It is possible to list all of the versions of `mmparse` available on your platform with:
